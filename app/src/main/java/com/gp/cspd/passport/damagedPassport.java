...
public class damagedPassport extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.btn_damaged_pass).setOnClickListener(this);
    ...
    public void onClick(View view) {
        switch (view.getId()){
            case R.id.cancel:
                startActivity(new Intent(damagedPassport.this, MainActivity.class));
                finish();
                break;
    ...
    public void imagePickerDialog(Bitmap bitmap){
        final Dialog dialog = new Dialog(damagedPassport.this);
    ...
    public void uploadImages(){
        ...
        String profilePicImageName= account.getSsn()+"damagedPassport."+getExtention(Uri_explon);
        String lost= account.getSsn()+"personalImgPassport."+getExtention(Uri_explon);
