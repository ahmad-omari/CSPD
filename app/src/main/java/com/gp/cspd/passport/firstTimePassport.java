...
public class firstTimePassport extends AppCompatActivity implements View.OnClickListener{
    ...
    public void onClick(View view) {
        switch (view.getId()){
            case R.id.cancel:
                startActivity(new Intent(firstTimePassport.this, MainActivity.class));
                finish();
                break;
    ...
    public void imagePickerDialog(Bitmap bitmap){
        final Dialog dialog = new Dialog(firstTimePassport.this);
        dialog.requestWindowFeature(Window.FEATURE_NO_TITLE);
    ...
    public void uploadImages(){
        ...
        String signatureImageName= account.getSsn()+"firstPassportNote."+getExtention(Uri_personal_pic);
        String authImageName= account.getSsn()+"firstPassportBook."+getExtention(Uri_written);
        String profilePicImageName= account.getSsn()+"firstPassportForeign."+getExtention(Uri_explon);
